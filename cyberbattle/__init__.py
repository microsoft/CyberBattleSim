...
register(
    ...
    kwargs={'defender_agent': None,
            'attacker_goal': AttackerGoal(own_atleast=6, own_atleast_percent=1.0),
...
if 'CyberBattleTiny-v1' in registry.env_specs:
    del registry.env_specs['CyberBattleTiny-v1']

register(
    id='CyberBattleTiny-v1',
    cyberbattle_env_identifiers=toy_ctf.ENV_IDENTIFIERS,
    entry_point='cyberbattle._env.cyberbattle_tiny:CyberBattleTiny',
    kwargs={'defender_agent': None,
            'attacker_goal': AttackerGoal(reward=1000),  # , own_atleast_percent=0.0),  # (own_atleast=6)
            'defender_goal': DefenderGoal(eviction=True),
            'maximum_total_credentials': 10,
            'maximum_node_count': 10,
            },
